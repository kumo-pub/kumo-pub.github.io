...
import vscode from '@site/static/img/kmpkg/get_started/vscode-c-extension.png';
...
import vscodecmake from '@site/static/img/kmpkg/get_started/vscode-cmake-extension.png';
...
import vscodecommand from '@site/static/img/kmpkg/get_started/vscode-command-build.png';

<img src={vscodecommand}/>

选择“默认”CMake 预设。这将启用 kmpkg 工具链。

import vscodecommandbuildpreset from '@site/static/img/kmpkg/get_started/vscode-command-build-preset.png';

<img src={vscodecommandbuildpreset}/>
