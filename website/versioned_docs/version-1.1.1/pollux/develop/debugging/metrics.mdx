...
Pollux emits several metrics during query execution which are useful to analyze the details of the underlying system and query processing. Some of these include:
