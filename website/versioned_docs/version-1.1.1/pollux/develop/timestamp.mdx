...
## Pollux Classes and APIs


Pollux provides a few classes and APIs to allow developers to store, process,
and convert timestamps across timezones:

**Timestamp:** In Pollux, timestamps are represented by the [Timestamp](https://github.com/facebookincubator/pollux/blob/main/pollux/type/Timestamp.h)
...
* Although Pollux supports nanoseconds precision, engines like Presto and Spark
...
**Timezone IDs:** To physically represent timezones, Pollux provides the
`TimezoneMap.h <https://github.com/facebookincubator/pollux/blob/main/pollux/type/tz/TimeZoneMap.h>`_
...
Timezone IDs in Pollux are based on the id map used by Presto and are
...
They are automatically generated using `this script <https://github.com/facebookincubator/pollux/blob/main/pollux/type/tz/gen_timezone_database.py>`_.
...
**TimestampWithTimezone:** To represent an absolute point in time, Pollux provides
`TimestampWithTimezone <https://github.com/facebookincubator/pollux/blob/main/pollux/functions/prestosql/types/TimestampWithTimeZoneType.h>`_.
...
`timezone conversion <https://github.com/facebookincubator/pollux/blob/main/pollux/functions/prestosql/DateTimeFunctions.h#L74-L84>`_.
...
In Pollux, Timezone conversions are done using std::chrono. Starting in C++20,
...
implementation of this API at `pollux/external/tzdb/ <https://github.com/facebookincubator/pollux/tree/main/pollux/external/tzdb>`_.
...
[can be found here](https://github.com/prestodb/presto/issues/7122)
...
``core::QueryConfig::kAdjustTimestampToTimezone`` query flag was added to Pollux.
...
* https://github.com/facebookincubator/pollux/issues/8037
