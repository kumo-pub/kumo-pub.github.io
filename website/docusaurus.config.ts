...
export default async function createConfigAsync() {
  return {
    ...
    organizationName: 'kumo',
    projectName: 'Kumo',
    baseUrl,
    baseUrlIssueBanner: true,
    url: 'https://kumo-pub.github.io',
    future: {
    ...
    themes: ['live-codeblock', 'docusaurus-theme-search-kumosearch', ...dogfoodingThemeInstances],
    plugins: [
      RsdoctorPlugin,
      [
      ...
      [
        'classic',
        {
          ...
          docs: {
            ...
            showLastUpdateAuthor: true,
            showLastUpdateTime: true,
            remarkPlugins: [[npm2yarn, {sync: true}], remarkMath, configTabs,[require('docusaurus-remark-plugin-codetabs'), {
              // options
            }],],
          ...
          blog: {
            ...
            showLastUpdateAuthor: true,
            showLastUpdateTime: true,
            remarkPlugins: [npm2yarn,[require('docusaurus-remark-plugin-codetabs'), {
              // options
            }],],
            postsPerPage: 5,
            feedOptions: {
    ...
    themeConfig: {
      ...
      announcementBar: {
        ...
        content: `🎉️ <b><a target="_blank" href="https://docusaurus.io/blog/releases/${announcedVersion}">Kumo v${announcedVersion}</a> is out!</b> 🥳️`,
      },
      prism: {
        additionalLanguages: [
          'java',
      ...
      */
      ...
      kumosearch: {
        ...
        kumosearchCollectionName: 'books',

        kumosearchServerConfig: {
          nodes: [
            {
              host: '127.0.0.1',
              port: 8688,
          ...
          apiKey: 'AdPlHUl6slGvpHjrLupaAANQeIC5pSw4OWozQxWulNWNnQXI',
        },
        kumosearchSearchParameters: {},
      ...
      navbar: {
        ...
        items: [
          ...
          {to: 'changelog', label: '发布', position: 'left'},
          {to: 'showcase', label: '应用案例', position: 'left'},
          {
            to: '/community/support',
            label: '支持与资源',
            position: 'left',
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'Gitee',
                href: 'https://gitee.com/kumo-pub',
              },
              {
                label: '网站',
                href: 'https://kumo-ai.tech',
              },
            ],
          },
          {
        ...
        copyright: `版权 © ${new Date().getFullYear()} 北京科米智创科技有限公司`,
      }
