...
与之相对的，如果直接拒绝掉一部分请求，反而能够让服务能够"及时"处理更多的请求。对应的方法就是[设置最大并发](https://github.com/apache/krpc/blob/master/docs/cn/server.md#%E9%99%90%E5%88%B6%E6%9C%80%E5%A4%A7%E5%B9%B6%E5%8F%91)。
...
的[变化更为平滑](https://github.com/apache/krpc/blob/master/src/krpc/policy/auto_concurrency_limiter.cpp#L249)。
